...
namespace NetSalaryCalculator.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            NetSalaryCalculatorDbContext data,
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(MaxNameLength, ErrorMessage = "The {0} must be at least {2} and at max {1} characters long.", MinimumLength = MinNameLength)]
